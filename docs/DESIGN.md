...
> Design notes for **creator-asset-upload-grants** — a runnable python example that Python service that mints presigned browser upload URLs for a creator storefront's masters, previews and subscriber-update attachments.
...
- **Feature code** — the actual task: browser-direct-upload.
